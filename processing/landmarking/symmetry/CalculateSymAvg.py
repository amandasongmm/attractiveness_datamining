...
results = pd.DataFrame(columns=('FA', 'CA', 'l1', 'l2', 'l3', 'l4', 'l5', 'l6', 'lh', 'AV'))
...
for i in range(NUM_IMG):
    ...
    oneLine = pd.Series([FA, CFA, l1, l2, l3, l4, l5, l6, lh, 0], index=results.columns)
...
for x in range(NUM_IMG):
    ...
    results.loc[x]['AV'] = averageness

results[['FA', 'CA', 'AV']].to_csv('AveragenessAndSymmetry.csv', index=False)